        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {products.map((product, i) => (
              <div
                key={i}
                className="product-card group flex flex-col bg-surface-light border border-border rounded-2xl overflow-hidden"
              >
                {/* Image */}
                ...
                <div className="flex flex-col flex-1 p-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="glow-btn mt-4 w-full flex items-center justify-center gap-2 bg-accent text-background border border-accent py-2.5 rounded-xl text-xs font-medium hover:bg-accent-light hover:text-background transition-all"
                  >
